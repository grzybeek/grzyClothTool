...
namespace CodeWalker.Rendering
{
    ...
    public class SkydomeShader : Shader, IDisposable
    {
        ...
        {
            byte[] skyvsbytes = Properties.Resources.SkydomeVS;
            byte[] skypsbytes = Properties.Resources.SkydomePS;
            byte[] sunvsbytes = Properties.Resources.SkySunVS;
            byte[] sunpsbytes = Properties.Resources.SkySunPS;
            byte[] moonvsbytes = Properties.Resources.SkyMoonVS;
            byte[] moonpsbytes = Properties.Resources.SkyMoonPS;
