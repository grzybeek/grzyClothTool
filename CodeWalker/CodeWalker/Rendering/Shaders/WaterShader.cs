...
namespace CodeWalker.Rendering
{
    ...
    public class WaterShader : Shader
    {
        ...
        {
            byte[] vsptbytes = Properties.Resources.WaterVS_PT;
            byte[] vspctbytes = Properties.Resources.WaterVS_PCT;
            byte[] vspnctbytes = Properties.Resources.WaterVS_PNCT;
            byte[] vspnctxbytes = Properties.Resources.WaterVS_PNCTX;
            byte[] psbytes = Properties.Resources.WaterPS;
            byte[] psdefbytes = Properties.Resources.WaterPS_Deferred;
