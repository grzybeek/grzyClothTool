...
namespace CodeWalker.Rendering
{
    ...
    public class TerrainShader : Shader, IDisposable
    {
        ...
        {
            byte[] vspncct = Properties.Resources.TerrainVS_PNCCT;
            byte[] vspncctt = Properties.Resources.TerrainVS_PNCCTT;
            byte[] vspnccttx = Properties.Resources.TerrainVS_PNCCTTX;
            byte[] vspncctttx = Properties.Resources.TerrainVS_PNCCTTTX;
            byte[] vspncctx = Properties.Resources.TerrainVS_PNCCTX;
            byte[] vspnctttx = Properties.Resources.TerrainVS_PNCTTTX;
            byte[] vspncttx = Properties.Resources.TerrainVS_PNCTTX;
            byte[] psbytes = Properties.Resources.TerrainPS;
            byte[] psdefbytes = Properties.Resources.TerrainPS_Deferred;
