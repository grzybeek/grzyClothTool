...
namespace CodeWalker.Rendering
{
    ...
    public class PathShader : Shader, IDisposable
    {
        ...
        {
            byte[] boxvsbytes = Properties.Resources.PathBoxVS;
            byte[] boxpsbytes = Properties.Resources.PathBoxPS;
            byte[] dynvsbytes = Properties.Resources.PathDynVS;
            byte[] vsbytes = Properties.Resources.PathVS;
            byte[] psbytes = Properties.Resources.PathPS;
        ...
        public void RenderLinesNew(DeviceContext context, List<VertexTypePC> verts, Camera camera, ShaderGlobalLights lights)
        {
            UseDynamicVerts = true;
            SetShader(context);
            SetInputLayout(context, VertexType.PC);
