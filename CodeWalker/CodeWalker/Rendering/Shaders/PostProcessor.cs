...
namespace CodeWalker.Rendering
{
    ...
    public class PostProcessor
    {
        ...
        public PostProcessor(DXManager dxman)
        {
            ...
            byte[] bReduceTo1DCS = Properties.Resources.PPReduceTo1DCS;
            byte[] bReduceTo0DCS = Properties.Resources.PPReduceTo0DCS;
            byte[] bLumBlendCS = Properties.Resources.PPLumBlendCS;
            byte[] bBloomFilterBPHCS = Properties.Resources.PPBloomFilterBPHCS;
            byte[] bBloomFilterVCS = Properties.Resources.PPBloomFilterVCS;
            byte[] bCopyPixelsPS = Properties.Resources.PPCopyPixelsPS;
            byte[] bFinalPassVS = Properties.Resources.PPFinalPassVS;
            byte[] bFinalPassPS = Properties.Resources.PPFinalPassPS;
