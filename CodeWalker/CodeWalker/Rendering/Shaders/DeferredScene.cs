...
namespace CodeWalker.Rendering
{
    ...
    public class DeferredScene
    {
        ...
        public DeferredScene(DXManager dxman)
        {
            ...
            byte[] bDirLightVS = Properties.Resources.DirLightVS;
            byte[] bDirLightPS = Properties.Resources.DirLightPS;
            byte[] bDirLightMSPS = Properties.Resources.DirLightPS_MS;
            byte[] bLodLightVS = Properties.Resources.LodLightsVS;
            byte[] bLodLightPS = Properties.Resources.LodLightsPS;
            byte[] bLodLightMSPS = Properties.Resources.LodLightsPS_MS;
            byte[] bLightVS = Properties.Resources.LightVS;
            byte[] bLightPS = Properties.Resources.LightPS;
            byte[] bLightMSPS = Properties.Resources.LightPS_MS;
            byte[] bFinalVS = Properties.Resources.PPFinalPassVS;
            byte[] bSSAAPS = Properties.Resources.PPSSAAPS;
