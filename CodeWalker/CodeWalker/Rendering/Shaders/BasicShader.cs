...
namespace CodeWalker.Rendering
{
    ...
    public struct BasicShaderTattooVars
    {
    ...
    public class BasicShader : Shader, IDisposable
    {
        ...
        GpuVarsBuffer<BasicShaderTattooVars> TattooVars;
        ...
        public BasicShader(Device device)
        {
            ...
            byte[] vspnctbytes = Properties.Resources.BasicVS_PNCT;
            byte[] vspncttbytes = Properties.Resources.BasicVS_PNCTT;
            byte[] vspnctttbytes = Properties.Resources.BasicVS_PNCTTT;
            byte[] vspncctbytes = Properties.Resources.BasicVS_PNCCT;
            byte[] vspnccttbytes = Properties.Resources.BasicVS_PNCCTT;
            byte[] vspncctttbytes = Properties.Resources.BasicVS_PNCCTTT;
            byte[] vspnctxbytes = Properties.Resources.BasicVS_PNCTX;
            byte[] vspncctxbytes = Properties.Resources.BasicVS_PNCCTX;
            byte[] vspncttxbytes = Properties.Resources.BasicVS_PNCTTX;
            byte[] vspnccttxbytes = Properties.Resources.BasicVS_PNCCTTX;
            byte[] vspnctttxbytes = Properties.Resources.BasicVS_PNCTTTX;
            byte[] vspncctttxbytes = Properties.Resources.BasicVS_PNCCTTTX;

            byte[] vspbbnctbytes = Properties.Resources.BasicVS_PBBNCT;
            byte[] vspbbnctxbytes = Properties.Resources.BasicVS_PBBNCTX;
            byte[] vspbbncttbytes = Properties.Resources.BasicVS_PBBNCTT;
            byte[] vspbbnctttbytes = Properties.Resources.BasicVS_PBBNCTTT;
            byte[] vspbbncctbytes = Properties.Resources.BasicVS_PBBNCCT;
            byte[] vspbbncctxbytes = Properties.Resources.BasicVS_PBBNCCTX;
            byte[] vspbbnccttxbytes = Properties.Resources.BasicVS_PBBNCCTTX;
            byte[] vspbbncttxbytes = Properties.Resources.BasicVS_PBBNCTTX;

            byte[] vsboxbytes = Properties.Resources.BasicVS_Box;
            byte[] vsspherebytes = Properties.Resources.BasicVS_Sphere;
            byte[] vscapsulebytes = Properties.Resources.BasicVS_Capsule;
            byte[] vscylinderbytes = Properties.Resources.BasicVS_Cylinder;
            byte[] psbytes = Properties.Resources.BasicPS;
            byte[] psdefbytes = Properties.Resources.BasicPS_Deferred;
            ...
            TattooVars = new GpuVarsBuffer<BasicShaderTattooVars>(device);
