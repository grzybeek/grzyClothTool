...
public class BuildResourceHelper
{
    ...
    public async Task BuildAltVFilesAsync(bool isMale, byte[] ymtBytes, int counter) {
        ...
        await Task.Run(() => {
            var generated = GenerateCreatureMetadata(drawables);
            if(generated != null) {
                if(!Directory.Exists(Path.Combine(firstLevelFolder, "creaturemetadata.rpf"))) {
                    Directory.CreateDirectory(Path.Combine(firstLevelFolder, "creaturemetadata.rpf"));
                }
                generated.Save(Path.Combine(firstLevelFolder, "creaturemetadata.rpf", $"mp_{projectName}.ymt"));
    ...
    public void BuildAltVTomls(List<string> metaFiles) {
        ...
        resourceTomlBuilder.AppendLine("# discord.gg/HCQutNhxWt");
        ...
        streamTomlBuilder.AppendLine("# discord.gg/HCQutNhxWt");
